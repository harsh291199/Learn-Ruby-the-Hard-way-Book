...
class CentralCorridor < Scene
  def enter()
    ...
    if action == 'shoot!'
      puts 'Quick on the draw you yank out your blaster,fire it at the Gothon.'
      puts 'His costume is flowing and moving around his body,which throws'
      puts 'off your aim.  Your laser hits his costume but misses him entirely.'
      puts 'completely ruins his brand new costume his mother bought him, which'
      puts 'makes him fly into an insane rage & blast you repeatedly'
      ...
      puts "Gothon stops,tries not to laugh,then busts out laughing &can't move"
